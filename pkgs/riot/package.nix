...

{
  ...
  by-version."are-we-there-yet"."1.1.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "http://registry.npmjs.org/are-we-there-yet/-/are-we-there-yet-1.1.2.tgz";
  ...
  by-version."async-each"."1.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "http://registry.npmjs.org/async-each/-/async-each-1.0.0.tgz";
  ...
  by-version."levn"."0.3.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "http://registry.npmjs.org/levn/-/levn-0.3.0.tgz";
      name = "levn-0.3.0.tgz";
  ...
  by-version."optionator"."0.8.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "http://registry.npmjs.org/optionator/-/optionator-0.8.1.tgz";
  ...
  by-spec."rimraf"."~2.5.1" =
    self.by-version."rimraf"."2.5.2";
  by-spec."riot-cli"."2.6.1" =
    self.by-version."riot-cli"."2.6.1";
  by-version."riot-cli"."2.6.1" = self.buildNodePackage {
    name = "riot-cli-2.6.1";
    version = "2.6.1";
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/riot-cli/-/riot-cli-2.6.1.tgz";
      name = "riot-cli-2.6.1.tgz";
      sha1 = "053eb866eef0b7912952ff2fb88812733fa264c7";
    };
    deps = {
      "chalk-1.1.3" = self.by-version."chalk"."1.1.3";
      ...
      "riot-compiler-2.5.2" = self.by-version."riot-compiler"."2.5.2";
      "rollup-0.32.4" = self.by-version."rollup"."0.32.4";
  ...
  "riot-cli" = self.by-version."riot-cli"."2.6.1";
  by-spec."riot-compiler"."^2.5.2" =
    self.by-version."riot-compiler"."2.5.2";
  by-version."riot-compiler"."2.5.2" = self.buildNodePackage {
    name = "riot-compiler-2.5.2";
    version = "2.5.2";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/riot-compiler/-/riot-compiler-2.5.2.tgz";
      name = "riot-compiler-2.5.2.tgz";
      sha1 = "956949f11e4dfa51d259db607145ec8e2934e47c";
    };
    deps = {
    };
    optionalDependencies = {
  ...
  by-spec."rollup"."^0.32.0" =
    self.by-version."rollup"."0.32.4";
  by-version."rollup"."0.32.4" = self.buildNodePackage {
    name = "rollup-0.32.4";
    version = "0.32.4";
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/rollup/-/rollup-0.32.4.tgz";
      name = "rollup-0.32.4.tgz";
      sha1 = "5d32efd6b9eceda26a8c3038481b389ed78a42a7";
    };
    deps = {
      "source-map-support-0.4.1" = self.by-version."source-map-support"."0.4.1";
    };
    optionalDependencies = {
    };
    peerDependencies = [];
  ...
  by-spec."source-map-support"."^0.4.0" =
    self.by-version."source-map-support"."0.4.1";
  by-version."source-map-support"."0.4.1" = self.buildNodePackage {
    name = "source-map-support-0.4.1";
    version = "0.4.1";
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/source-map-support/-/source-map-support-0.4.1.tgz";
      name = "source-map-support-0.4.1.tgz";
      sha1 = "b0a9280fdb28a812286cbba843ddb0f00b057203";
    };
    deps = {
